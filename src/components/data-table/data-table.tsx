...
export function DataTable<TData, TValue>({
  ...
  // Always call hook to follow Rules of Hooks - React requires hooks to be called unconditionally
  // Only use the result if providedTable is not provided
  const autoTable = useDataTableInstance<TData, TValue>({ 
    data: (data ?? []) as TData[], 
    columns,
    enableRowSelection: false,
  });
  const table = providedTable ?? autoTable;
